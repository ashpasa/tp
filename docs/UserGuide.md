...
Displays a list of modules required for the selected specialisation.
...
Helps to balance workload of study plan by detecting any semesters with unusually high workload.
